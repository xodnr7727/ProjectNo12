...
// Called every frame
void AMySkillClass::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

void AMySkillClass::ProjectileHit_Implementation(FHitResult HitResult, AActor* Shooter, AController* ShooterController)
{
	if (ImpactSound)
	{
